...
const CACHE_NAME = "godotPlays-cache";
const OFFLINE_URL = "godotPlays.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["godotPlays.html","godotPlays.js","godotPlays.wasm","godotPlays.pck","godotPlays.offline.html","godotPlays.icon.png","godotPlays.apple-touch-icon.png"];
